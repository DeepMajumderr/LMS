...
const StudentsEnrolled = () => {
  ...
  const { currency, backendUrl, isEducator, getToken,fetchEnrolledStudents,enrolledStudents } = useContext(AppContext)
  ...
  return enrolledStudents ? (
    <div className='min-h-screen flex flex-col items-start justify-between md:p-8md:pb-0 p-4 py-8 pb-0'>
