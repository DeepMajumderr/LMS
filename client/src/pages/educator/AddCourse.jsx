    ...
    md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input onChange={(e) => setCourseTitle(e.target.value)} type="text"
            value={courseTitle} placeholder='Type here' className='outline-none md:py-2.5
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            <p>Course Price</p>
            <input onChange={(e) => setcoursePrice(e.target.value)} type="number" placeholder='0' className='outline-none
          ...
          {showPopup && (
            <div className='fixed inset-0 flex items-center justify-center
              ...
              <div className='bg-white text-gray-700 p-4 rounded relative w-full
                ...
                <button onClick={addLecture} type='button' className='w-full bg-blue-400 text-white px-4
