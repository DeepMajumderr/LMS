  ...
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-30 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        ...
        <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>
          we bring together world-class instructors, interactive content, and a supportive community to help you achieve your personal and professsional goals.</p>

        <p className='md:hidden text-gray-500 max-w-sm mx-auto'>we bring together world-class instructors, interactive content, and a supportive community to help you achieve your personal and professsional goals.</p>
